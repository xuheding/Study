...
public partial class HDevelopExport
{
  ...
  private void action()
  {
    ...
    HObject ho_ModelTrans=null, ho_UnionContours=null, ho_Region=null;
    HObject ho_greenTestImageMedian=null, ho_showImage=null;
    ...
    for (hv_I=0; (int)hv_I<=(int)((new HTuple(hv_Score.TupleLength()))-1); hv_I = (int)hv_I + 1)
    {
      ...
      HOperatorSet.PaintRegion(ho_Region, ho_testImageMedian, out ho_greenTestImageMedian, 
          255, "fill");
